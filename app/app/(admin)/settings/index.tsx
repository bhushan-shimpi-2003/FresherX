...
export default function AdminSettingsScreen() {
  ...
  const handleExportUsers = () => {
    if (Platform.OS === 'web') window.alert('Exporting Users CSV...');
    else Alert.alert('Export Started', 'Users CSV is being generated.');
  };

  const handleExportJobs = () => {
    if (Platform.OS === 'web') window.alert('Exporting Jobs CSV...');
    else Alert.alert('Export Started', 'Jobs CSV is being generated.');
  };
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        <Animated.View entering={FadeInDown.delay(250).springify()} style={styles.group}>
          ...
          <View style={[styles.settingsCard, { backgroundColor: theme.colors.card, borderColor: theme.colors.border }]}>
            ...
            <TouchableOpacity style={styles.settingRow} activeOpacity={0.7} onPress={handleExportUsers}>
            ...
            <TouchableOpacity style={styles.settingRow} activeOpacity={0.7} onPress={handleExportJobs}>
              <View style={[styles.iconWrap, { backgroundColor: theme.colors.accent + '20' }]}>
                <Download size={18} color={theme.colors.accent} />
              </View>
              <Text style={[styles.settingLabel, { color: theme.colors.text, fontFamily: theme.typography.fontFamily.medium, flex: 1 }]}>
