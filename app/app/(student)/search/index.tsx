...
export default function SearchScreen() {
  ...
  const toggleJobType = (type: JobType) => {
    ...
    fetchJobs({ keyword: keyword || undefined, jobType: updated.length ? updated : undefined, isRemote }, true);
  };
            ...
            return (
              <Chip
                ...
                onPress={() => {
                  ...
                  setIsRemote(newVal);
                  fetchJobs({ keyword: keyword || undefined, jobType: selectedTypes.length ? selectedTypes : undefined, isRemote: newVal }, true);
                }}
              />
            );
          }
